  ...
  <body>
    ...
    <section class="services min-vh-100 pb-5 position-relative" id="services" >
      ...
      <div class="container-md mt-5 mb-5" id="contact">
        <div class="row">
          <div class="col-md footer-head">
          Contact Us
            <div class="row">
              <div class="col-md mb-2 footer-text">Main Headquarter: City Health Office, Angeles City</div>
            </div>
            <div class="row">
              <div class="col-md mb-2 footer-text">Email: Carepath@gmail.com</div>
            </div>
            <div class="row">
              <div class="col-md footer-text">Call: (+63) 942-9900-320</div>
            </div>
          </div>
