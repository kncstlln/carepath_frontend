  ...
  <body>
        ...
        <div class="container-sm mt-4">
            ...
            <div class="container-sm ps-4 createRecord">
                <div class="row">
                    <div class="col-md-1 mt-3"><a href="{{ url('/infant') }}"><i class="fa-solid fa-angle-up fa-rotate-270 fa-2xl"></i></a></div>
                    <div class="col-md-10 h2 mb-5 mt-3 text-center">View Infant Record</div>
                </div>
                <div>
                    <form>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-3">
                          <div class="col-md-3 h4">Parents Information</div>
                        </div>
                        <div class="row mb-2">
                          <div class="col-md-2 pt-2 txtBold">Father's Name: </div>
                          <div class="col-md-2 pt-2">Jello P. Mangune</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-2 pt-2 txtBold">Mother's Name: </div>
                            <div class="col-md-2 pt-2">Nathaniel T. Allapitan</div>
                        </div>
                        <div class="row mb-2">
                          <div class="col-md-2 pt-2 txtBold">Contact Number: </div>
                          <div class="col-md-1 pt-2">09429900320</div>
                        </div>
                        <div class="row mb-4">
                          <div class="col-md-2 pt-2 txtBold">Complete Address: </div>
                          <div class="col-md pt-2">Angeles University Foundation, Brgy. Salapungan, 2009 Angeles City, Philippines</div>
                        </div>
