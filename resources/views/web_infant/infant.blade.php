...
<head>
  ...
  @include('sidebar')
      ...
      <div class="container-sm mt-4" id="targetclientlist">
        ...
        <div class="row">
            <div class="col-sm">
              <a class="btn btn-primary btn-lg float-end mb-4" href="{{ url('/addInfant') }}" role="button" id="button-add">Add Infant +</a>
            </div>
        </div>
      </div>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td><a href="viewInfant.html"><i class="fa-solid fa-eye me-2"></i></a><a href="editInfant.html"><i class='bx bxs-pencil me-2'></i></a><i class="fa-solid fa-trash"></i></td>
              </tr>
              <tr>
                <th scope="row">2</th>
