    ...
    <div class="container content createRecord mt-5">
        ...
        <div class="row">
            <div class="col-12 col-md-6 mb-3">
                ...
                <input class="form-control" type="text" placeholder="Password" aria-label="currentPassword">
            </div>
            <div class="col-12 col-md-6 mb-3">
        ...
        <div class="row mb-4 mt-5 justify-content-center text-center">
            <div class="col-md-3 col-lg-2 mt-1">
                <a href="account"><button type="button" class="btn btn-secondary cancelButton">Cancel</button></a>
            </div>
            <div class="col-md-3 col-lg-2 mt-1">
